...
public class ClienteServiceImpl implements pe.idat.BackEndConecta.service.ClienteService {
    ...
    public ClienteRegistrationDTO registrarCliente(ClienteRegistrationDTO dto) {
        ...
        if (clienteOpt.isPresent()) {
            ...
            if (personaRepository.findByDocumento(dto.getDocumento()).isPresent()) {
                throw new IllegalArgumentException("Ya existe una persona registrada con el documento: " + dto.getDocumento());
            }
        ...
        Distrito distrito = distritoRepository.findById(dto.getDistritoId())
                .orElseThrow(() -> new IllegalArgumentException("No se encontró el distrito con ID: " + dto.getDistritoId()));
    ...
    public Page<ClienteDTO> buscarClientes(String documento, String celular, Integer id, String nombres, String apellidoPaterno, Pageable pageable) {
        Page<Cliente> clientes = clienteRepository.buscarClientesConFiltros(documento, celular, id, nombres, apellidoPaterno, pageable);
    ...
    public void eliminarCliente(Integer id) {
        ...
        // TODO: Validar que el cliente no tenga contratos activos antes de dar de baja
    ...
    private String generarDireccionCompleta(ClienteRegistrationDTO dto, String nombreDistrito) {
        ...
        if (dto.getNombreVia() != null) sj.add(dto.getNombreVia());
        if (dto.getNumero() != null) sj.add("Nro " + dto.getNumero());
        ...
        if (dto.getManzana() != null) sj.add("Mz. " + dto.getManzana());
        if (dto.getLote() != null) sj.add("Lt. " + dto.getLote());
        if (dto.getPiso() != null) sj.add("Piso " + dto.getPiso());
        if (dto.getInterior() != null) sj.add("Int. " + dto.getInterior());
